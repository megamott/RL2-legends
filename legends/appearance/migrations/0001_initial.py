# Generated by Django 3.2.6 on 2021-08-19 06:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='appearance.category', verbose_name='parent category, to achieve nesting of categories')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, default=appearance.models.Category.get_default_pk, on_delete=django.db.models.deletion.SET_DEFAULT, to='appearance.category', verbose_name='which category the question belongs to')),
            ],
            options={
