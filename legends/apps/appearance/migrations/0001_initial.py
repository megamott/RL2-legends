    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, default=legends.apps.appearance.models.QuestionCategory.get_default_pk, on_delete=django.db.models.deletion.SET_DEFAULT, to='appearance.questioncategory', verbose_name='which category the question belongs to')),
                ('question_author', models.ForeignKey(blank=True, default=legends.apps.appearance.models.UserManager.get_default_user, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL, verbose_name='which user the question belongs to')),
            ],
            options={
